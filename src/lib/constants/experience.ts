...
NodeJS.
- More details on my resume [**here**](https://drive.google.com/file/d/1q88_CevucpqpTx5ShO1VrXXua5ihV3eL/view?usp=sharing)
`,
        skills: [
          "Javascript",
          "Typescript",
...
`,
  ...
  {
    company: "Kilimall International",
    positions: [
      {
...
- Created a [**user-friendly guide for integrating with Lipa Na M-Pesa**](https://github.com/HawiCaesar/pay_confirmation).
  ...
  {
    company: "HP Strathmore Research Lab",
    positions: [
      {
        title: "Web Developer",
